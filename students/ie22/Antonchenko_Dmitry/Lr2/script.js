window.onload = function() {
    ...
    let buttonGithub = document.getElementById("btn_github");
    ...
    buttonGithub.addEventListener("click", RedirectToGithub);
    ...
    function ChangeTheme() {
        if (!isAnimated) {
            // Переключаем классы для изменения темы
    ...
    function RedirectToGithub() {
        window.location.href = "https://github.com/Findoshka"; 
    }
